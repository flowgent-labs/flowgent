...
type TaskPlanPostgresStore struct {
	inner *store.PostgresGenericStore[model.TaskRun]
}
...
func (s *TaskPlanPostgresStore) CreateTaskRun(ctx context.Context, e *model.TaskRun) error {
...
func (s *TaskPlanPostgresStore) UpdateTaskRun(ctx context.Context, e *model.TaskRun) error {
