...
func (l *Logger) Debug(msg string, args ...any) {
	l.LogAttrs(nil, slog.LevelDebug, msg, toAttrs(args)...)
}
func (l *Logger) Info(msg string, args ...any) {
	l.LogAttrs(nil, slog.LevelInfo, msg, toAttrs(args)...)
}
func (l *Logger) Warn(msg string, args ...any) {
	l.LogAttrs(nil, slog.LevelWarn, msg, toAttrs(args)...)
}
func (l *Logger) Error(msg string, args ...any) {
	l.LogAttrs(nil, slog.LevelError, msg, toAttrs(args)...)
}
