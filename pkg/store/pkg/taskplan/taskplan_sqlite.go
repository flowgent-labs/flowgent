...
func (s *TaskPlanSQLiteStore) Get(ctx context.Context, id string) (*model.TaskRun, error) {
	return s.inner.Get(ctx, id)
}
func (s *TaskPlanSQLiteStore) Select(ctx context.Context, req model.PageRequest) (*model.Page[model.TaskRun], error) {
	return s.inner.Select(ctx, req)
}
func (s *TaskPlanSQLiteStore) Save(ctx context.Context, e *model.TaskRun) error {
