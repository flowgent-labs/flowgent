...
func (s *AgentFlowSQLiteStore) Get(ctx context.Context, id string) (*model.AgentFlowVersion, error) {
	return s.inner.Get(ctx, id)
}
func (s *AgentFlowSQLiteStore) Select(ctx context.Context, req model.PageRequest) (*model.Page[model.AgentFlowVersion], error) {
	return s.inner.Select(ctx, req)
}
func (s *AgentFlowSQLiteStore) Save(ctx context.Context, e *model.AgentFlowVersion) error {
