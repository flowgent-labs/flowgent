...
5. **Wallet E2E execution** — `usecase/security-autonomy-fixer/e2e-verification/scenarios/11_wallet_verifier.py` is added but still depends on a running wallet service and EMQX to execute fully.
