"""
Scenario 08 — Notifier: Multi-Channel Delivery via MQTT + REST.

Verifies:
  1. EMQX broker reachable
  2. Notification channel CRUD via REST
  3. POST /notifications/test smoke test
  4. notify/event → notify/result MQTT roundtrip
"""
